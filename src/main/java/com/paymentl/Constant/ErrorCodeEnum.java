...
public enum ErrorCodeEnum {
	...
	GENERIC_ERROR("10000" , "Something went Wrong  please try again later  "),
	 ...
	 INVALID_AMOUNT("30004" , "Amount must be greater than zero "), CANCEL_URL_REQUIRED("30005" , "Cancel Url is required field and cannot be null / blank "), PAYPAL_SERVICE_UNAVAILABLE("40001" , "PayPal service is currently unavailable , please try again later ") ;
